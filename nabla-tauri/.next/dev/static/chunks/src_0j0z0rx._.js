...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            async function loadConfig() {
                try {
                    let defaultConfig = "";
                    const isTauriEnv = ("TURBOPACK compile-time value", "object") !== "undefined" && "__TAURI_INTERNALS__" in window && window.__TAURI_INTERNALS__ !== undefined;
                    if (isTauriEnv) {
    ...
    const runSimulation = async (isLoop)=>{
        ...
        try {
            ...
            if (isTauriEnv) {
                const { save } = await __turbopack_context__.A("[project]/node_modules/@tauri-apps/plugin-dialog/dist-js/index.js [app-client] (ecmascript, async loader)");
                const { writeFile } = await __turbopack_context__.A("[project]/node_modules/@tauri-apps/plugin-fs/dist-js/index.js [app-client] (ecmascript, async loader)");
